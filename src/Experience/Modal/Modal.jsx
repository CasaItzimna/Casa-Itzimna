...
const Modal = ({ show, onClose, children }) => {
  ...
  return (
    ...
    <div className="fixed   lg:top-[15%] 2xl:top-[30%] z-30 inset-0 overflow-y-auto   ">
 ...
 */}        <div
          className="inline-block align-bottom bg-white rounded-lg text-left  shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg lg:max-w-4xl xl:max-w-5xl   2xl:max-w-4xl  sm:w-full"
          role="dialog"
          aria-modal="true"
