...
function Productos() {
    const {getProductos, postProducto, updateProducto, productos, isLoading} = AppContext()
    useEffect(() => {
        getProductos()
      }, [])
    ...
    const handlePrevPage = () => {
      ...
      const currentProductos = productosFecha?.slice(indexOfFirstProducto, indexOfLastProducto )
...
<h2 className="text-2xl lg:text-4xl  font-apollo tracking-[2px] mb-8 lg:text-white">Productos</h2>
...
<button onClick={handlePrevPage} >
  ...
  <button onClick={handleNextPage} >
    <FaArrowRight className={currentProductos.length < productosPerPage? "hidden": "text-[#d3cbc0] lg:text-white text-3xl "}/>
  </button>
</div>
</div>
...
<div className="flex flex-row  gap-4 col-span-2 mt-4">
              ...
              <h3 className="uppercase ">productos:</h3>
