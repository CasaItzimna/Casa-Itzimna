    ...
    <div className="w-full h-full flex flex-col relative">
      ...
      <div className="flex flex-row justify-center  h-screen w-full max-w-[1920px]  text-white absolute z-40">
            ...
            <div className="w-full h-full flex flex-col justify-center text-center items-center">
              <h1 className="text-9xl font-cinzelRegular"><span className="text-[200px]">C</span>asa <span className="text-[200px]">I</span>tzimná</h1>
              <h2 className="text-6xl font-cinzelRegular">Boutique</h2>

              <div className="flex flex-row  w-[40%] h-[65px] bg-white/40 mt-14 justify-center items-center rounded-md ">
