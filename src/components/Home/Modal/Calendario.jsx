  ...
  for (let i = 1; i <= daysInMonth; i++) {
    ...
    days.push(
      <div
        ...
        ${
          //Hace seleccionables los dias despues de hoy
          i > today.getDate() && isReserved ? "text-gray-200 " : ""
        }
        ...
        ${
          ...
          i === fin?.getDate() &&
          fin?.getMonth() === todayMonth.getMonth() &&
          !isReserved
      ...
      >
        <div className="flex flex-col">
          ...
          {!fechas.find(
            (fecha) =>
              fecha.fecha ===
              `${currentYear}-${String(todayMonth.getMonth() + 1).padStart(
                2,
                "0"
...
<span key={index} className="text-[10px] lg:text-[7px] 2xl:text-[9px]">
          ...
          {!fechas.find(
            (fecha) =>
              fecha.fecha ===
              `${currentYear}-${String(nextMonth.getMonth() + 1).padStart(
                2,
                "0"
              )}-${String(i).padStart(2, "0")}`
          ) && (
            ...
            <div className="flex flex-row justify-center mb-4">
              <div className="text-xl font-bold text-black flex flex-row justify-center items-center gap-4">
                {!inicio && !fin && (
                  <FaAngleLeft
                    className={
                      sumMonth - 1 == 0 ? "hidden" : "cursor-pointer z-10"
                    }
