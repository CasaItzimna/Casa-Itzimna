          ...
          <div className="w-full h-full flex flex-col justify-start lg:justify-center text-center lg:text-left ">
            <div className="w-full flex flex-row justify-center lg:justify-end">
              <div className="w-full lg:w-[90%] xl:w-[80%]  2xl:xl:w-[570px] ">
                ...
                <p className=" text-justify font-ethereal text-xl px-8 md:px-0 lg:px-0 md:w-[600px] lg:w-[480px] text-[#31302c] tracking-[1px]">
                  {json.About.text}
                </p>
                </div>
                <Link href="/AboutUs">
                  <button className="rounded-[4px] bg-[#d3cbc0] hover:bg-[#a59f98] w-[200px] h-[45px] mt-8 font-apollo text-xl tracking-[4px] mb-4 ">
